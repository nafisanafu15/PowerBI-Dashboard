...
function applyFilters() {
  ...
  updateTable(data);
  if (currentType !== 'table') drawChart(currentType);
}
...
// Draws the chart with the same full/part time split shown on the Leader Dashboard
function drawChart(type) {
  const labels = ['Full-time', 'Part-time', 'Online'];
